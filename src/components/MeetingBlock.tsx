import { CADENCE_LABELS, CADENCE_STYLES } from "@/src/lib/types";
import type { LayoutItem } from "@/src/lib/utils";
import { darkenHex, fmt12, hexToLight } from "@/src/lib/utils";
...
export default function MeetingBlock({ item }: Props) {
	...
	return (
		<div
			...
			className="transition-shadow hover:z-[5] hover:shadow-md"
		>
			<div
				style={{
					fontSize: "11px",
